...
const ContactForm = () => {
  ...
  return (
    ...
    <h6 className='col-2'>{Langsar.title_form}:</h6>
    <select
      name='title'
      {...register('title', {
        required: {
      ...
      <option value='Mrs'>Mrs</option>
                ...
                {/* Row 1 of form */}
                 <div className='h-100 col justify-content-between align-items-center '>
                    <div className=' row d-flex justify-content-between align-items-center  '> 
                    <h6 className='col-2 ' >{Langsar.contactName}:</h6>
                    <input
                      type='text'
                      name='name'
                      {...register('name', {
   ...
   <div className=' row d-flex justify-content-between align-items-center  '> 
                  ...
                  <div className=' row d-flex justify-content-between align-items-center'> 
                    <h6 className='col-2 ' >{Langsar.phoneNumber}:</h6>
                    <input
                      type='text'
                      name='name'
                      {...register('name', {
                  ...
                  <div className='col'>
                   <div className='row d-flex justify-content-between align-items-center '> 
                    <h6 className='col-2' >{Langsar.subject}:</h6>
                    <input
                      type='text'
                      name='subject'
                      {...register('subject', {
